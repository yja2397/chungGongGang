...
public class Crawl{
	...
	ArrayList<String> table; // 공지사항 ArrayList
	ArrayList<String> tableA; // 공지사항 표 중 a tag만 모아둔 ArrayList
	ArrayList<String> tableAHref; // 공지사항 표 중 a tag의 url들만 모아놓은 제목 ArrayList
	String url; // url
	String name; // 어떤 종류의 사이트인지 알려줌.(cnu, dom, sw, com)
	String str; // table html 가져오는 String
