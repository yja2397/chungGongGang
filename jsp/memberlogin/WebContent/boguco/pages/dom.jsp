...
<div class="wrapper row0">
    <div id="topbar" class="hoc clear">
        ...
        <div class="fl_left">
            <ul class="nospace">
                <li><i class="fa fa-phone"></i>042-821-5114</li><!--충남대학교 홈페이지-->
                <li><i class="fa fa-envelope-o"></i> dbwjddus1997@gmail.com | yja2397@gmail.com</li> <!--유정연, 윤지애 이메일 주소-->
            </ul>
        </div>
        <div class="fl_right">
            <ul class="nospace">
                <li><a href="../index.html"><i class="fa fa-lg fa-home"></i></a></li>
                <li><a href="about.html">About</a></li> <!--개발자 정보-->
                <li><a href="login.html">Login</a></li><!--로그인-->
                <li><a href="join.html">Register</a></li><!--회원가입-->
            </ul>
        </div>
        <!-- ################################################################################################ -->
    </div>
        ...
        <header id="header" class="hoc clear">
            ...
            <nav id="mainav" class="fl_right">
                <ul class="clear">
                    ...
                    <li><a class="drop">공지사항</a><!--공지사항 메뉴-->
                        <ul>
                            <li class="submenu"><a href="notice.html">충남대 공지사항</a></li><!--충남대 공지사항-->
                            <li class="submenu"><a href="#">기숙사 공지사항</a></li><!--기숙사 공지사항-->
                            <li class="submenu"><a href="#">SW 사업단 공지사항</a></li><!--SW 공지사항-->
                            <li class="submenu"><a href="#">컴퓨터공학과 공지사항</a></li><!--컴공 공지사항-->
                        </ul>
                    </li>

                    <li><a class="drop">키워드 알림</a><!--키워드 알림 메뉴-->
                        <ul>
                            <li class="submenu"><a href="alarm.html" target="iframe">알림 설정</a></li><!--알림 설정-->
                            <li class="submenu"><a href="alarmconfirm.html" target="iframe">알림 확인</a></li><!--알림 확인-->
                        </ul>
                    </li>
                </ul>
            </nav>
    ...
    <div class="wrapper row2">
        <div id="breadcrumb" class="hoc clear">
            ...
            <ul>
                ...
                <li><a>공지사항</a></li>
                <li><a href="notice.html">충남대 공지사항</a></li>
            </ul>
            <!-- ################################################################################################ -->
        </div>
    </div>
...
<div class="wrapper row3">
    ...
    <main class="hoc container clear">
        ...
        <!-- ################################################################################################ -->
        <div class="content">
            <h1>기숙사 공지사항</h1><!--사이트 공지사항-->
            <div class="info">총 #### 건 / 금일 : ### 건</div>
            <!--검색창-->
            <div class="search" style="grid-area: search">
                <form action="#" method="post" id="search_position" style="float:right">
                    <input list="search" name="subject" class="input" size="22" style="float:left">
            ...
            <div class="scrollable">
                <table><!--공지사항 받아오는 표.-->
                    ...
                    <%
      String url = "https://dorm.cnu.ac.kr/_prog/_board/?code=sub05_0501&site_dvs_cd=kr&menu_dvs_cd=0501";
         t.setting("dom", url);
...
<div class="bgded overlay" style="background-image:url('../images/demo/backgrounds/04.png');">
    ...
    <div class="wrapper row5">
        <div id="copyright" class="hoc clear">
            <!-- ################################################################################################ -->
            <p class="fl_left">Copyright &copy; 2018 - All Rights Reserved - <a href="../index.html">ChungGongGang</a></p>
